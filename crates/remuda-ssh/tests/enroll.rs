...
use remuda_ssh::{
    HubEnroll, NodeTransport, StdioTransport, adapt_hello_for_hub, enroll_stdio, node_socket_url,
};
...
#[tokio::test]
async fn enroll_stdio_sends_adapted_hello_with_bearer() {
...
#[test]
fn adapt_hello_is_public() {
    let adapted = adapt_hello_for_hub(json!({"params":{"host":{"hostId":"hst_1"}}}), "x");
    assert_eq!(adapted["params"]["hostId"], "hst_1");
}
