...
export function ContextUsagePopover({
  ...
  mobile: boolean;
  onClose: () => void;
  /** Desktop anchor: opens upward from the chip bar (mirrors the effort menu). */
  anchorUp?: boolean;
  /** Shared menu-panel ref so the composer's placement probe can measure it. */
  ...
  return (
    <div
      ...
      } ${anchorUp ? css.popoverUp : mobile ? "" : css.popoverDown}`}
