...
pub fn schema_document() -> Value {
    ...
    register! {
        ...
        Host,
        HostEnv,
        hubnode::HostFileEntry,
        hubnode::HostFileKind,
        hubnode::HostFileReadResult,
        hubnode::HostFileSearchMatch,
        hubnode::HostFileSearchMode,
        hubnode::HostFilesListResult,
        hubnode::HostFilesParams,
        hubnode::HostFilesSearchParams,
        hubnode::HostFilesSearchResult,
        HostId,
        HostParams,
        HostReportParams,
        HostReportResult,
